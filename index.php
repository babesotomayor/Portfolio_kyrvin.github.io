...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2>I'm a Student in <span><?=$data['title']?></span> </h2>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link" href="#services">Hobbies</a></li>
          ...
          <div class="row">
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Address:</strong> <span><a style="color: white;" href="<?=$data['website']?>" target="_blank"><?=$data['website']?></a></span></li>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>objective</h4>
            <p><em>Motivated Student and Hardworking. Seeking to apply my knowledge and experience from my past school years. Ready to utilize my skills, passions, positive attitude, willingness and motivation to learn new things.</em></p>
           
          </div>

          <h3 class="resume-title">Work Experience</h3>
          <div class="resume-item">
            <h4>Assistant Computer hardware</h4>
            <h5>2012 - 2015</h5>
            <p><em>Delmonte National High School</em></p>
            <p>Working as an Assistant student of my teacher in high school in teaching the components of computers in hardware and sofware.</p>
          </div>
          <div class="resume-item">
            <h4>Assistant Technician</h4>
            <h5>2014 - 2018</h5>
            <p><em>Kabasalan Zamboanga Sibugay</em></p>
            <p>I work with my Dad as an Assistant Technician and i have more experience with computers in software and hardware.</p>
          </div>
        </div>
        <div class="col-lg-6">
        
          <div class="resume-item">
            <h4>Future Web Designer</h4>
            <h5>2019 - Present</h5>
            <p><em>Pagadian City </em></p>
            <p>Student of Southerm Mindanao Colleges and i have enough knowledge about design program and need more experience to achieve my course.</p>
          </div>
          ...
          <div class="resume-item">
            ...
            <h5>2021 - 2024</h5>
            <p><em>SMC Pagadian City</em></p>
          </div>
          <div class="resume-item">
            <h4>Bachelor in Civil Engineering</h4>
            <h5>2017 - 2019</h5>
            <p><em>Misamis University Ozamiz City</em></p>
          </div>
          <div class="resume-item">
            <h4>STEM</h4>
            <h5>2014 - 2016</h5>
